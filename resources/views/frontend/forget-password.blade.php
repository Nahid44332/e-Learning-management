...
<head>
  ...
  <title>Forget Password - E-Learn</title>
...
<div class="min-h-screen flex items-center justify-center px-4">
  <div class="max-w-md w-full bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-10">
    ...
    <div class="text-center mb-6">
      ...
      <p class="text-gray-500 dark:text-gray-400 text-sm mt-1">Enter your email address and we'll send you a reset link.</p>
    </div>
    ...
    <form action="#" method="POST" class="space-y-5">
      ...
      <button type="submit" class="w-full py-3 rounded-lg bg-primary text-white font-semibold hover:bg-blue-600 transition">Send Reset Link</button>
    </form>

    <p class="text-center text-sm text-gray-500 dark:text-gray-400 mt-6">
      Back to <a href="{{url('/login')}}" class="text-primary font-semibold hover:underline">Login</a>
    </p>
  </div>
</div>
